...
export default function ModalComponent({show, handleClose, details}) {
    ...
    const handleSubmit = (event) => {
        ...
        if(details.id) {
            axios
            .put(`https://pern-curd-project-v1.onrender.com/api/v1/updateProduct/${details.id}`, data)
            .then((res) => {
            ...
            axios
            .post('https://pern-curd-project-v1.onrender.com/api/v1/createProduct', data)
            .then((res) => {
                console.log(res.data)
                setFormData({productName: "", categoryId: ""});
                handleClose();
